...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $opportunityProduct->opportunity_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $opportunityProduct->opportunity_id)]
            )
        ?></li>
...
<div class="opportunityProducts form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Opportunity Product') ?></legend>
        <?php
