...
class NotificationsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Objects', 'Sources', 'Users', 'NotificationTypes']
        ];
    ...
    public function add()
    {
        ...
        $objects = $this->Notifications->Objects->find('list', ['limit' => 200]);
        ...
        $this->set(compact('notification', 'objects', 'sources', 'users', 'notificationTypes'));
    }
