...
class ConsultationsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['ConsultationTypes', 'Employees']
        ];
    ...
    public function add()
    {
        ...
        $employees = $this->Consultations->Employees->find('list', ['limit' => 200]);
        $this->set(compact('consultation', 'consultationTypes', 'employees'));
    }
