...
class PermissionsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['UserInterfaces', 'Actions', 'Profiles']
        ];
    ...
    public function add()
    {
        ...
        $userInterfaces = $this->Permissions->UserInterfaces->find('list', ['limit' => 200]);
        $actions = $this->Permissions->Actions->find('list', ['limit' => 200]);
        $profiles = $this->Permissions->Profiles->find('list', ['limit' => 200]);
        $this->set(compact('permission', 'userInterfaces', 'actions', 'profiles'));
    }
