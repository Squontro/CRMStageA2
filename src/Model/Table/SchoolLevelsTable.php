 ...
 * @method \App\Model\Entity\SchoolLevel newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\SchoolLevel[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\SchoolLevel|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\SchoolLevel|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\SchoolLevel patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\SchoolLevel[] patchEntities($entities, array $data, array $options = [])
...
class SchoolLevelsTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['level_stude_id'], 'LevelStudes'));
