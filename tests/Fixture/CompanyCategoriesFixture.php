...
/**
 * CompanyCategoriesFixture
 */
class CompanyCategoriesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'modification_date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
