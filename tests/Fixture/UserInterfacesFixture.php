...
/**
 * UserInterfacesFixture
 *
 */
class UserInterfacesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'fk_Interfaces_Sections1_idx' => ['type' => 'index', 'columns' => ['section_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_Interfaces_Sections1' => ['type' => 'foreign', 'columns' => ['section_id'], 'references' => ['sections', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
