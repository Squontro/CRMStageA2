...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'emailaddress' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-02-28 18:59:09',
                'modified' => '2019-02-28 18:59:09'
            ],
        ];
        parent::init();
    }
