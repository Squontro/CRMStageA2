...
class LeavesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'date_leave_start' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'date_leave_end' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'employee_id' => 1,
                'leave_type_id' => 1,
                'date_leave_start' => '2019-02-28',
                'date_leave_end' => '2019-02-28'
            ],
        ];
        parent::init();
    }
